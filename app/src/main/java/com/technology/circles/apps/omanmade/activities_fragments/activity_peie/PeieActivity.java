                    ...
                    public void onResponse(Call<AppDataModel> call, Response<AppDataModel> response) {
                        ...
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            if (response.code() == 500) {
                                Toast.makeText(PeieActivity.this, "Server Error", Toast.LENGTH_SHORT).show();

                            } else {
                                Toast.makeText(PeieActivity.this, getString(R.string.failed), Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (t.getMessage() != null) {
                                ...
                                if (t.getMessage().toLowerCase().contains("failed to connect") || t.getMessage().toLowerCase().contains("unable to resolve host")) {
                                    Toast.makeText(PeieActivity.this, R.string.something, Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(PeieActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            }
